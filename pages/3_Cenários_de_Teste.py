...
st.title("🔍 Cenários de Teste & Critérios de Aceitação")
st.write("Nada de deploy com surpresa! O POwerUp gera cenários de teste e critérios de aceitação bem definidos, garantindo que tudo esteja pronto para a próxima sprint. ✅🔄")

# Inicializar o histórico específico do assistente no session_state
ASSISTANT_ID = "testing" # ID único para o assistente
